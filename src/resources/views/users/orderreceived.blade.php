...
@section('content')
<main id="received-sec" class="py-3">
      <div class="received-thanks">
        <h2>THANK YOU!</h2>
        <div class="img-wrap">
          <svg
      ...
      <div class="received-section">
        <section id="received-sec-wrap">
          ...
          @foreach ($userOrder as $usOrd)
            <div class="received-items">
              <div class="received-items-name">{{ $usOrd->item->name }} &times; {{ $usOrd->unit }}</div>
              <div class="received-items-amount">&#8358; {{ number_format($usOrd->item->new_price * $usOrd->unit) }}</div>
            </div>
          @endforeach
        ...
        <aside>
          ...
          <div class="order-received">
            <div class="order-received-grp">
              ...
              <p class="receive-value">{{ $userPayment->order_number }}</p>
            </div>
            <div class="order-received-grp">
              <p class="receive-head">Date</p>
              <p class="receive-value">{{ date("M d \, Y",strtotime($userPayment->created_at)) }} </p>
            </div>
            <div class="order-received-grp">
              <p class="receive-head">Total</p>
              <p class="receive-value">&#8358; {{ number_format($userPayment->totalpayment) }}</p>
            </div>
            <div class="order-received-grp">
              <p class="receive-head">Payment Method</p>
              <p class="receive-value">{{ $userPayment->gateway }}</p>
            </div>
          </div>
        </aside>
      </div>
