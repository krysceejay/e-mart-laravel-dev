...
<main id="received-sec" class="py-3">
      ...
      <div class="received-section">
        <section id="received-sec-wrap">
          ...
          <div class="received-items">
            <div class="received-items-name">Bag &times; 2</div>
            <div class="received-items-amount">&#8358; 3,500</div>
          </div>
          <div class="received-items">
            <div class="received-items-name">Watch &times; 1</div>
            <div class="received-items-amount">&#8358; 7,000</div>
          </div>
