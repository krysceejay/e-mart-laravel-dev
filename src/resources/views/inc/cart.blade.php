    ...
    <div id="cart{{ $cart->item_id }}" class="cart-items-single">
      ...
      <div class="cart-item-text">
        ...
        <div class="quantity-control">
          ...
          <input class="catnumber{{ $cart->item_id }}" min="1" max="2000" value="{{ $cart->unit }}" type="number" iid="{{ $cart->item_id }}" />
          <button
            class="plus getval"
